...
#define defaults_h
 ...
 #ifdef DEFAULTS_MULTIBOT_LRP
// Description: Multibot LRP with four NEMA 17 stepper motors.
// CNC xPro
...
#define DEFAULT_X_ACCELERATION (1200.0*60*60) // 15*60*60 mm/min^2 = 15 mm/sec^2
#define DEFAULT_Y_ACCELERATION (1200.0*60*60) // 15*60*60 mm/min^2 = 15 mm/sec^2
#define DEFAULT_Z_ACCELERATION (800.0*60*60) // 15*60*60 mm/min^2 = 15 mm/sec^2
#define DEFAULT_X_MAX_TRAVEL 511.0 // mm
#define DEFAULT_Y_MAX_TRAVEL 422.0 // mm
#define DEFAULT_Z_MAX_TRAVEL 242.0 // mm
#define DEFAULT_STEP_PULSE_MICROSECONDS 10
#define DEFAULT_STEPPING_INVERT_MASK 0
